...
function changeFocus(dir) {
	...
	if(dir) {
		...
		$("#focusIndex"+currentFocusI+" .focusL").animate({left: -($(window).width()/2+1026)},300,'easeInExpo');
		$("#focusIndex"+currentFocusI+" .focusR").animate({left: -($(window).width()/2+1026)},500,'easeInExpo',function(){
				$("#focusIndex"+nextI+" .focusL").animate({left: -513},1026,'easeInOutCirc');
				$("#focusIndex"+nextI+" .focusR").animate({left: -513},1226,'easeInOutCirc');
				
				$("#focusIndex"+currentFocusI).animate({left: -$(window).width()},1026,'easeOutExpo');
				$("#focusIndex"+nextI).animate({left: 0},1026,'easeOutExpo',function(){
		...
		$("#focusIndex"+nextI).css("left",-$(window).width());
		$("#focusIndex"+nextI+" .focusL").css("left",-($(window).width()/2+1026));
		$("#focusIndex"+nextI+" .focusR").css("left",-($(window).width()/2+1026));
		$("#focusIndex"+currentFocusI).show();
		$("#focusIndex"+nextI).show();
		...
		$("#focusIndex"+currentFocusI+" .focusL").animate({left: $(window).width()/2},500,'easeInExpo',function(){
				$("#focusIndex"+nextI+" .focusL").animate({left: -500},1226,'easeInOutCirc');
				$("#focusIndex"+nextI+" .focusR").animate({left: -500},1026,'easeInOutCirc');

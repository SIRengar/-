...
<title>组织机构_江西晟金实业有限公司 浙江晟金通用部件制造有限公司</title>
<!--公共用js begin-->
...
<div class="mainWarp">
	<div class="main clearfix">
    	<!--sub_box begin-->
   		<div class="sub_box">
        	<p class="position"><a href="index.php">首页</a>&nbsp;&gt;&nbsp;<a href="javascript:;" >关于我们</a>&nbsp;&gt;&nbsp;<a href="zzjg.asp" class="position_cur">组织机构</a></p>	
            <div class="sub_con">
            	<!--about begin-->
            	<div class="about">
                <img src="upfile/201510/2015100853271709.jpg" alt="" />
                </div>
                <!--about end-->
            </div>
        </div>
        ...
        <div class="side">
            ...
            <ul class="sideNav">
                ...
                <li class="sideCur"><a href="zzjg.asp">组织机构</a></li>
